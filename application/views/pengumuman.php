              ...
              <div id="isi">	
                ...
                <div style="text-align:justify;border-bottom:1px solid #CCCCCC;padding-bottom:10px;">
                    ...
                    <div style="clear:both;">
                        <a href="<?php echo site_url(); ?>pengumuman/detail/<?php echo $pengumuman->id_pengumuman; ?>"><input type="button" class="btn btn-danger" value="readmore" style="margin-left:100px;" /></a>
                    </div>
                </div>
                <?php } ?>
              </div>          
